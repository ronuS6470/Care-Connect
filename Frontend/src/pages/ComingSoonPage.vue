...
const title = computed(() => (route.meta.title as string | undefined) ?? 'Coming soon')
</script>
...
<template>
  <div>
    ...
    <EmptyState title="This page is on the way" description="This part of CareConnect is still being built out. Check back soon.">
      <template #icon>
